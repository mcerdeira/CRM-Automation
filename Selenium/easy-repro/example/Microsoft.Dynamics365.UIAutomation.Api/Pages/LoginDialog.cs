...
namespace Microsoft.Dynamics365.UIAutomation.Api
{
        ...
        : XrmPage
    {
        ...
        public BrowserCommandResult<bool> CloseAlert(int thinkTime = Constants.DefaultThinkTime)
        {
            this.Browser.ThinkTime(thinkTime);
            return this.Execute(GetOptions("Close Alerts"), driver =>
            {
        ...
        public BrowserCommandResult<bool> ADFSLoginAction(SecureString username, SecureString password)
        {
